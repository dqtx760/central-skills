...
options:
  - label: "Project"
    description: ".claude/skills/ (current project only)"
  - label: "User"
    description: "~/.claude/skills/ (all projects)"
```
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.claude/skills/baoyu-article-illustrator/EXTEND.md` | Current project |
| User | `~/.claude/skills/baoyu-article-illustrator/EXTEND.md` | All projects |
